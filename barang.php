...
<!-- //tes -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h1 class="mt-5">MASTER BARANG</h1>
		  <p style="float: right;">
				<a href="tambah_barang.php"><button type="button" class="btn btn-primary btn-lg">Tambah</button></a>
		  </p>
	...
	?>
			<tr>
				...
				<td>
					<a href="edit_barang.php?id=<?php echo $row['barangId']; ?>">Edit</a>
					<a href="delete_barang.php?id=<?php echo $row['barangId']; ?>">Delete</a>
				</td>
			</tr>
		<?php } ?>
